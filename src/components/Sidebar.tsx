            ...
            <div className="no-scrollbar h-full overflow-auto py-6 px-4 lg:py-8">
                <div className="flex flex-col gap-6">
                    <div className="flex flex-col gap-1"><h4
                        className="rounded-md px-2 py-1 text-start text-lg font-medium">Getting Started</h4>
                    ...
                    <div className="flex flex-col gap-1"><h4
                        className="rounded-md px-2 py-1 text-start text-lg font-medium">Components</h4>
                        <div className="grid grid-flow-row auto-rows-max gap-0.5 text-sm">
